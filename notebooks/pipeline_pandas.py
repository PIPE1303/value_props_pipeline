...
def extract_value_prop_id(df):
    ...
    if "value_prop" in df.columns:
        ...
        raise KeyError("No se encontró la columna value_prop_id, value_prop ni event_data en el DataFrame")
    return df
...
print("Dataset generado exitosamente con Pandas.") 